...
$(document).ready(function () {
  ...
  function startPlayerGame() {
    ...
    // Switching between players in the turn
    ...
    // Showing the players which player won
    function whoWon() {
      if (points[0] >= 5) {
        alert("Player 1 wins!");
        resetGame();
    ...
    // Resetting after the game is over
    function resetGame() {
      debugger;
      points = [0, 0];
      currentPlayer = 1;
